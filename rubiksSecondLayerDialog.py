def rubiksSecondLayerDialog(favoriteColor):
    searching = input("Now that you've completed the first layer of the cube, we're going to complete the second layer. In order to to this, look for an edge piece on the bottom layer that matches both center colors in the second layer. In the rare case that there's no edge pieces in the bottom layer, proceed to the next step and don't worry about matching the colors .Enter 'done' to proceed or 'help' if you need additional assistance.")
    if searching == 'done':
            found = input("Now that you've found an edge piece, match either one of the edge pieces colors to one of its corresponding center pieces. Enter 'done' to move onto the next step or 'help' if you need extra help. ")
    elif searching == 'help':
