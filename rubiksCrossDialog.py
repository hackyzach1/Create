def rubiksCross():
    ...
    align1 = input("Find a " + favoriteColor + " edge piece and move it next to the " + favoriteColor + " center piece. Notice how each edge piece has two sides, each with a different color? Align the" +favoriteColor+ "edge piece's other color with its corresponding center. Repeat this step until you're done with the cross! Say 'done' to move on or 'help' if you want more specific instructions.  ")
    if align1 != "done":
        if align1 == "help":
            print("Check out the sergs B on youtube for some detailed, helpful instructions. ")
        else: print("I'm not sure what you mean. Say 'help' or 'done' to move on. ")
